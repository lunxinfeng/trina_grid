...
class TrinaGridConfiguration {
  ...
  /// Custom filter popup
  final TrinaGridFilterPopupConfig filterPopupConfig;
  ...
  const TrinaGridConfiguration({
    ...
    this.filterPopupConfig = const TrinaGridFilterPopupConfig(),
  });
  ...
  TrinaGridConfiguration copyWith({
    ...
    TrinaGridFilterPopupConfig? filterPopupConfig,
  }) {
    return TrinaGridConfiguration(
      ...
      filterPopupConfig: filterPopupConfig ?? this.filterPopupConfig,
    );
  }
  ...
  bool operator ==(covariant Object other) {
    return identical(this, other) ||
        other is TrinaGridConfiguration &&
            ...
            filterPopupConfig == other.filterPopupConfig;
  }
...
/// Custom filter popup.
class TrinaGridFilterPopupConfig {

  const TrinaGridFilterPopupConfig({
    this.headerIconSpacing = 0.0,
    this.headerAddIconBuilder,
    this.headerRemoveIconBuilder,
    this.headerClearIconBuilder,
    this.headerAppendBuilder,
  });

  /// Spacing between icons in the header of the filter popup.
  final double headerIconSpacing;

  /// Builder for the "Add Filter" icon in the header of the filter popup.
  final WidgetBuilder? headerAddIconBuilder;

  /// Builder for the "Remove Filter" icon in the header of the filter popup.
  final WidgetBuilder? headerRemoveIconBuilder;

  /// Builder for the "Clear Filters" icon in the header of the filter popup.
  final WidgetBuilder? headerClearIconBuilder;

  /// Builder for appending a custom widget to the header of the filter popup.
  final WidgetBuilder? headerAppendBuilder;

  @override
  bool operator ==(covariant Object other) {
    return identical(this, other) ||
        other is TrinaGridFilterPopupConfig &&
            runtimeType == other.runtimeType &&
            headerIconSpacing == other.headerIconSpacing &&
            headerAddIconBuilder == other.headerAddIconBuilder &&
            headerRemoveIconBuilder == other.headerRemoveIconBuilder &&
            headerClearIconBuilder == other.headerClearIconBuilder &&
            headerAppendBuilder == other.headerAppendBuilder;
  }

  @override
  int get hashCode => Object.hash(
        headerIconSpacing,
        headerAddIconBuilder,
        headerRemoveIconBuilder,
        headerClearIconBuilder,
        headerAppendBuilder,
      );
}
